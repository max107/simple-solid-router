import { match, type Match, type MatchFunction as RegexMatchFunction, parse, type Token } from "path-to-regexp";
import { buildFrom, cleanPath, type ParsedHistoryLocation, splitUri } from "./utils";
...
export type RouteRenderFunction = any | Promise<any>;
...
export type CurrentRouteParams<K = any, E = any> = {
    params: K,
    query: E
}

export type CurrentRouteMatch<K extends CurrentRouteParams = { params: any, query: any }> = DynamicProps & K & {
    name?: string
    path: string
};
